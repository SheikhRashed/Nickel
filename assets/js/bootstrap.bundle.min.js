...
!(function (t, e) {
	...
	class et extends B {
		...
		_getConfig(t) {
			return (
				((t = { ...J, ...t }).toggle = Boolean(t.toggle)), l("collapse", t, tt), t
			)
		}
		_getDimension() {
	...
	function Zt(t, e) {
		...
		var f = u.reduce(function (e, i) {
			return (
				(e[i] = Gt(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[
					gt(i)
				]),
				e
			)
...
//# sourceMappingURL=bootstrap.bundle.min.js.map
>>>>>>> 9754ec2e0d0e5a60bd021d20db88215af1d80a04
